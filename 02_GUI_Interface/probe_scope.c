...
*
* 
* Modification on this file for mtb-example-xmc-6edl7141-trapezoidal-1shunt 
* - add include header to the register_map.h and ucProbe_scope.h
...
#include "01_TopLevel/register_map.h"
...
volatile int32_t Scope_Ch1, Scope_Ch2, Scope_Ch3, Scope_Ch4; 	            // Latest scope trace channel value, 
                                                                            // other purpose is to allow Micro Inspector 
															                // add 4 meaningful symbols 
 ...
 if ((p_ch->En == 1) && (trace_id < REGISTER_MAP_SIZE))
    {
        ...
        switch (data_type) {
            ...
            case PROBE_SCOPE_FP32:
                 ...
                 return_value = (int32_t) p_sample->ValFP32;
                 break;
#endif
        }
    }
